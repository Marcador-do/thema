    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="encuesta col-sm-12">
            <header class="row">
                <span class="col-xs-4">ENCUESTA</span>
                <span class="participantes col-xs-4">41 Participantes</span>
                <span class="cta col-xs-4"><i class="material-icons">fast_forward</i>Ver Respuestas</span>
            </header>
